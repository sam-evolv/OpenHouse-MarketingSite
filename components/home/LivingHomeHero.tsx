    ...
    <section className="relative isolate overflow-hidden bg-carbon pt-32 text-white sm:pt-36 lg:min-h-[900px] lg:pt-44" aria-labelledby="home-hero-title">
      ...
      <Container>
        <div className="grid items-center gap-14 pb-20 lg:grid-cols-[0.82fr_1.18fr] lg:gap-10 lg:pb-28">
          <div className="relative z-30 max-w-2xl [contain:layout_paint_style]">
            ...
            <p className="mt-5 text-xs leading-relaxed text-porcelain/60">{heroContent.proof}</p>
          </div>
      ...
      <div className="border-t border-white/8">
        <Container>
          <div className="grid gap-4 py-6 text-[0.6875rem] uppercase tracking-[0.14em] text-porcelain/60 sm:grid-cols-3 sm:items-center sm:gap-6">
